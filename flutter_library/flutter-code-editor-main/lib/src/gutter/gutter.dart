...
class GutterWidget extends StatelessWidget {
  ...
  Widget _buildOnChange(BuildContext context, Widget? child) {
    ...
    // Reduce gutter width for a more compact appearance
    final compactGutterWidth = gutterWidth * 0.7; // 70% of original width

    final issueColumnWidth = style.showErrors ? _issueColumnWidth * 0.7 : 0.0;
    final foldingColumnWidth =
        style.showFoldingHandles ? _foldingColumnWidth * 0.7 : 0.0;
    ...
    return Container(
      ...
      width: style.showLineNumbers ? compactGutterWidth : null,
      child: Table(
        columnWidths: {
