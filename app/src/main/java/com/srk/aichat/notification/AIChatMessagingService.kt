...
class AINotificationService : FirebaseMessagingService() {
    companion object {
        private const val TAG = "AINotificationService"
        const val CHANNEL_ID = "aichat_notifications"
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.data.isNotEmpty()) {
            ...
            val title = remoteMessage.data["title"] ?: "New Message from AI:Ask Anything"
